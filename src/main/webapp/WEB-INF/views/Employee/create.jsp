								...
								<div
									...
									<div class="controls">
										<input type="text" name="firstName" id="firstName"
											value="${firstName}" data-rule-required="true"
								...
								<div
									...
									<div class="controls">
										<input type="text" name="lastName" id="lastName"
											value="${lastName}" data-rule-required="true"
								...
								<div
									...
									<div class="controls">
										<input type="text" name="birthday" id="birthday"
											value="${birthday}" class="datepick"
											data-rule-required="true" /> <span class="help-block error">${birthdayError}</span>
									</div>
								</div>
								<div
									...
									<div class="controls">
										<input type="text" name="phone" id="phone" class="mask_phone"
											value="${phone}" data-rule-required="true" /> <span
								...
								<div
									...
									<div class="controls">
										<textarea style="resize: none" name="address"
											data-rule-required="true" data-rule-maxlength="150">${address}</textarea>
							...
							<div class="span6">
								<div
									...
									<div class="email controls">
										<input type="text" id="email" name="email" value="${email}" placeholder="someone@xample.com"
											data-rule-required="true" data-rule-email="true" /> <span
											class="help-block error">${emailError}</span>
									</div>
								</div>
								<div
								...
								<div
									...
									<div class="controls">
										<input type="text" name="insMoneyAcceptedPerYear"
											...
											value="${insMoneyAcceptedPerYear}" data-rule-number="true" />
										<span class="help-block error">${insMoneyAcceptedPerYearError}</span>
									</div>
